...
COLOR = dict(base_plate="#4d7fc4", stand="#9aa0a6", nest="#dfa03a",
             cover="#c0574f", pcba="#12602c", probes_hw="#d8b23a",
             fit_gauge="#6f8fae")
...
VIEWS = {
    ...
    "stand_top":       ([("stand", 0)], 20, 62,
                        "stand from above - one clear cavity, four lid bosses, ST-Link ribs"),
...
LABELS = {
    ...
    "exploded": [((-58, 0, -30), "stand", -40), ((-7, -38, 14), "clamp tower", 40),
